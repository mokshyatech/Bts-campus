    ...
    //URL Validation      
          if(!isset($edit))
         {
            ...
            if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
             ...
             $sql="select * from school_teacher where email='$email' limit 1 ";
      ...
      if(!$uppercase || !$lowercase || !$number ||  strlen($password) < 8)   
       ...
       {
       	 header("location:school_teacher_registration.php?type=edit&&id=$id");
       	 exit();
       }
      }
      ...
      {  
      	  if($fnameErr==true || $lnameErr==true || $addressErr==true || $emailErr==true || $passwordErr==true || $contactErr==true)  
       {
       	 header("location:school_teacher_registration.php");
       	 exit();
       }
