...
<a href="masscommunication11.php" style="color: black; text-decoration: none;"><button class="button button2">Mass Communication<br>(162)</button></a>
<a href="sociology11.php" style="color: black; text-decoration: none;"><button class="button button1">Sociology  <br>(172)</button></a>
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from college_resource where humanities = 1 and class = 11 and subject = 'health education' ORDER BY id ASC LIMIT $start_from, $limit";
...
?>
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from college_resource where humanities = 1 and class = 11 and subject = 'health education'";
                      $query=mysqli_query($db,$sql);
