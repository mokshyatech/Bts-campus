...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from college_resource where humanities = 1 and class = 11 and subject = 'nepali' ORDER BY id ASC LIMIT $start_from, $limit";
...
?>
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from college_resource where humanities = 1 and class = 11 and subject = 'nepali'";
                      $query=mysqli_query($db,$sql);
