...
<div class="row" style="justify-content: center;">
 ...
 <h1 style="text-align: center; color: green;">HUMANITIES</h1>
      
 <h1 style="text-align: center; color: green;">WELCOE TO CLASS 12 HEALTH AND PHYSICAL EDUCATION</h1>
      
  <div class="row" style="justify-content: center;">      

        
<a href="english12.php" style="color: black; text-decoration: none;"><button class="button button1">C.English<br>(004)</button></a>         
<a href="nepali12.php" style="color: black; text-decoration: none;"><button class="button button2">Optional Nepali<br>(232)</button></a>
<a href="optenglish12.php" style="color: black; text-decoration: none;"><button class="button button1">Optional English <br>(220)</button></a>
<a href= "healtheducation12.php" style="color: black; text-decoration: none;"><button class="button button2" style="background-color: #a8f7ad;">Health and Physical <br>Education(244)</button></a>
<a href="masscommunication12.php" style="color: black; text-decoration: none;"><button class="button button1">Mass Communication<br>(262)</button></a>
<a href="sociology12.php" style="color: black; text-decoration: none;"><button class="button button2">Sociology <br>(272)</button></a>
<a href="population12.php" style="color: black; text-decoration: none;"><button class="button button1">Population<br>Studies(246)</button></a>
<a href="social12.php" style="color: black; text-decoration: none;"><button class="button button2">Social studies<br>(930)</button></a>
</div>
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from college_resource where humanities = 1 and class = 12 and subject = 'health education' ORDER BY id ASC LIMIT $start_from, $limit";
...
?>
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from college_resource where humanities = 1 and class = 12 and subject = 'health education'";
                      $query=mysqli_query($db,$sql);
  ...
  <ul class="pagination justify-content-center">
   <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='healtheducation12.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='healtheducation12.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?></li>
    <li class="page-item">
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='healtheducation12.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
