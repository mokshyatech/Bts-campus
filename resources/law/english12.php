...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from college_resource where law = 1 and class = 12 and subject = 'english' ORDER BY id ASC LIMIT $start_from, $limit";
...
?>
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from college_resource where law = 1 and class = 12 and subject = 'english'";
                      $query=mysqli_query($db,$sql);
