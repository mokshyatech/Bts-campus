...
<div class="row" style="justify-content: center;">
 ...
 <h1 style="text-align: center; color: green;">EDUCATION</h1>
      
 <h1 style="text-align: center; color: green;">WELCOE TO CLASS 12 OPTIONAL HEALTH AND PHYSICAL EDUCATION</h1>
...
<a href="childrendev12.php" style="color: black; text-decoration: none;"><button class="button button2">Children Development <br>& Learning(902)</button></a>
<a href="evaluation12.php" style="color: black; text-decoration: none;"><button class="button button1">Instructional  <br>Evaluation(918)</button></a>
</div>
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from college_resource where education = 1 and class = 12 and subject = 'health education' ORDER BY id ASC LIMIT $start_from, $limit";
...
?>
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from college_resource where education = 1 and class = 12 and subject = 'health education'";
                      $query=mysqli_query($db,$sql);
