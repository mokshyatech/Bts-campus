...
<div class="row" style="justify-content: center;">
 ...
 <h1 style="text-align: center; color: green;">WELCOE TO CLASS 11 OPTIONAL NEPALI</h1>
...
<a href="optnepali11.php" style="color: black; text-decoration: none;"><button class="button button2" style="background-color: #a8f7ad;">Optional Nepali<br>(132)</button></a>
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from college_resource where education = 1 and class = 11 and subject = 'optional nepali' ORDER BY id ASC LIMIT $start_from, $limit";
...
?>
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from college_resource where education = 1 and class = 11 and subject = 'optional nepali'";
                      $query=mysqli_query($db,$sql);
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='optnepali11.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?> 
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='optnepali11.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?></li>
    <li class="page-item">
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='optnepali11.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
