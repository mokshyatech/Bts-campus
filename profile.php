...
class password extends database
  {
     ...
     public function checkoldpassword($postData)
    {
     ...
     if(strlen($new_password)<6)
     {
      ...
      $query = "select * from student where id='$id' and password='$old_password' ";
...
<html lang="en">
  ...
  <?php include "include/banner.php"; ?>
    ...
    <!-- navbar --><?php include "include/navbar.php"; ?>
    ...
    <div class="row justify-content-center">
      ...
      <h3 style="text-align: center; color: #6AAC6F">Welcome <?php echo $_SESSION['login_user'];?></h3>
        <?php 
 $query = ("SELECT * FROM student WHERE firstname='" . $_SESSION["login_user"] ."'");
   ...
   <div class="col-md-offset-3 col-md-3">
    <form action="profile.php?type=changepassword" method="post">
      ...
      <div class="form-group">
       ...
       <input type="hidden" name="id" value="<?php echo $_SESSION['stu_id'];?>">
      </form>
    </div>
